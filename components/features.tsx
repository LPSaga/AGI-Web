      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-hkgrotesk mb-4">Simple, Clear, Useful For</h2>
          ...
          <div className="carousel swiper-container">
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide h-auto flex flex-col bg-slate-800 p-6 rounded">
                ...
                <div className="grow">
                  <div className="font-hkgrotesk font-bold text-xl">Developers</div>
                  <div className="text-slate-500 mb-3">
                  Developers build and maintain ecosystem apps, profiting from sales, subscriptions, and earning rewards through token incentives and participation income.
                  </div>
                </div>
              ...
              <div className="swiper-slide h-auto flex flex-col bg-slate-800 p-6 rounded">
                ...
                <div className="grow">
                  <div className="font-hkgrotesk font-bold text-xl">Users</div>
                  <div className="text-slate-500 mb-3">
                  Users can earn tokens by participating in activities, enriching the ecosystem, and use them to access AI applications for free or at reduced costs.
                  </div>
                </div>
                <div className="text-right">
                  <a className="font-medium text-indigo-500 inline-flex items-center transition duration-150 ease-in-out group" href="#0">
              ...
              <div className="swiper-slide h-auto flex flex-col bg-slate-800 p-6 rounded">
                ...
                <div className="grow">
                  <div className="font-hkgrotesk font-bold text-xl">Idle computing power providers</div>
                  <div className="text-slate-500 mb-3">
                  Individuals or institutions provide computing power and data for large model training, earning tokens based on service time, quality, and data usage, incentivizing continuous support and maximizing data value.
                  </div>
                </div>
                <div className="text-right">
                  <a className="font-medium text-indigo-500 inline-flex items-center transition duration-150 ease-in-out group" href="#0">
